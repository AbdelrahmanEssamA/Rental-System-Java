...
public class BuyerDashboard extends javax.swing.JFrame {
    ...
    public BuyerDashboard(Document buyer) {
        initComponents();
        jLabelName.setText(buyer.get("fullName").toString());
        jLabelBalance.setText(buyer.get("blance").toString());
        currentBuyer = buyer;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Browse Properties");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        new PropertyList(currentBuyer).setVisible(true);
