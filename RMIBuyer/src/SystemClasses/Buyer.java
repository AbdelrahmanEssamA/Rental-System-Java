...
public class Buyer extends AuthorizedUser implements Serializable {
    ...
    public Buyer(double blance, ArrayList<Contract> contracts, ArrayList<Review> reviews, Advertiser advertiser, int id, String fullName, String email, String phone, String addres, String profilePicture, String password, boolean status) {
